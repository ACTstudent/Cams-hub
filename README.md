...
The landing page currently targets [CAMS v2.5.4](https://github.com/ACTstudent/RemoteAcessMonitoringSoftware4sale/releases/tag/v2.5.4), the latest published release:

- [CAMS Server Setup](https://github.com/ACTstudent/RemoteAcessMonitoringSoftware4sale/releases/download/v2.5.4/CAMS-Server-Setup.exe)
- [CAMS Student Client](https://github.com/ACTstudent/RemoteAcessMonitoringSoftware4sale/releases/download/v2.5.4/CAMS-Client-Setup.exe)
